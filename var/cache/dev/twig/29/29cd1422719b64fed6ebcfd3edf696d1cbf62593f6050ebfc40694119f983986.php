...
class __TwigTemplate_73c4d902da63590fa9ca312e2b59c9178fed71d7630e7f8fdafb7961a97ac068 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "        <div class=\"mb-3 text-light\">
    ...
    ";
        // line 17
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "user", [], "any", false, false, false, 17), false))) {
            // line 18
            echo "    <h1 class=\"h3 mb-3 font-weight-normal text-light\">Zaloguj się</h1>
...
";
    ...
    {
        return array (  157 => 46,  146 => 43,  139 => 38,  133 => 25,  125 => 20,  121 => 18,  119 => 17,  116 => 16,  108 => 13,  105 => 12,  103 => 11,  100 => 10,  94 => 8,  92 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
", "security/login.html.twig", "/home/mariusz/Symfony/forumApp/templates/security/login.html.twig");
    }
}
